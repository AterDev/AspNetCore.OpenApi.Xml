...
function showEndpoint(endpoint)
{
    ...
    let html = `
        <div class="endpoint-detail-header">
            ...
            <div class="endpoint-meta">
                <span class="badge method-badge fs-6 method-${endpoint.method.toLowerCase()}">${endpoint.method}</span>
    ...
    if (endpoint.description)
    {
        html += `
        <div class="card my-1">
            <div class="card-header"><i class="bi bi-code"></i>CodePath</div>
            <div class="card-body">
            <strong>
            ${endpoint.tags}/${endpoint.description}
            </strong>
            </div>
        </div>`;
    }
